...
?>
  <head>
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
        ...
        <li class="nav-item">
        <a class="nav-link" href="http://localhost/HRPJ/HR/TimeAttendanceSearchForHR-01.php?id=$id">Time Attendance</a>
        </li>
        <li class="nav-item">
...
<br><br>
  ...
  <dd class="col-sm-9"><?php echo "$positionName" ;?></dd>
    ...
    <br><br><br>
    <div class="edit">
    <button type="button" class="btn btn-dark" onclick="window.location.href = 'TimeManageFindForHR.html';">Confirm</button> <button type="button" class="btn btn-light" onclick="window.location.href = 'TimeAttendanceSearchForHR.html';">Cancel</button>
    </div>
    <!-- Optional JavaScript -->
